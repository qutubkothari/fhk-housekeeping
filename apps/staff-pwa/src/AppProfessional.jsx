  ...
  if (['admin', 'super_admin', 'inventory', 'laundry'].includes(user?.role)) {
    ...
    return (
      ...
      >
        ...
        {!['dashboard', 'rooms', 'housekeeping', 'maintenance', 'staff', 'inventory', 'linen', 'reports', 'realtime', 'assignments', 'analytics', 'activity-master', 'bulk-assignment', 'location-master', 'shift-master', 'vendor-management', 'procurement', 'settings'].includes(currentPage) && (
          <div className="flex items-center justify-center h-64">
            <div className="text-center">
              <div className="text-6xl mb-4">🚧</div>
